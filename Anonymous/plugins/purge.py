...
from Anonymous.helpers.filters import admin_filter, bot_owner_filter as owner
from Anonymous import app


@app.on_message(filters.command("purge") & (admin_filter | owner), group=98979)
...
@app.on_message(filters.command("spurge") & (admin_filter | owner), group=8989899)
...
@app.on_message(filters.command("del") & (admin_filter | owner), group=8989979)
